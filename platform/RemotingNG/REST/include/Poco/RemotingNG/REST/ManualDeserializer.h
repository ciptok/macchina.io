...
#ifndef RemotingNG_REST_ManualDeserializer_INCLUDED
#define RemotingNG_REST_ManualDeserializer_INCLUDED
...
class RemotingNGREST_API ManualDeserializer : public Poco::RemotingNG::Deserializer
{
public:
	ManualDeserializer();
...
#endif // RemotingNG_REST_ManualDeserializer_INCLUDED
