...
#ifndef RemotingNG_REST_ManualSerializer_INCLUDED
#define RemotingNG_REST_ManualSerializer_INCLUDED
...
class RemotingNG_API ManualSerializer: public Poco::RemotingNG::Serializer
{
public:
	ManualSerializer();
...
private:
	...
	friend class ManualDeserializer;
};
...
#endif // RemotingNG_REST_ManualSerializer_INCLUDED
