...
//
// $Id: //poco/1.4/CppParser/testsuite/src/AttributesParserTest.cpp#1 $
//
...
void AttributesParserTest::testParser8()
{
	Attributes attrs;
	std::istringstream istr("get = {path=\"/prod/{id}\"}");
	AttributesParser parser(attrs, istr);
	parser.parse();
	assert (attrs.getString("get.path") == "/prod/{id}");
}
...
CppUnit::Test* AttributesParserTest::suite()
{
	...
	CppUnit_addTest(pSuite, AttributesParserTest, testParser8);
